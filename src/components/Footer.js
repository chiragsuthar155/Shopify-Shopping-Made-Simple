...
export const Footer = () => {
  return (
    <>
      <div className="w-full flex flex-col items-evenly  mt-20 bg-gray-800 text-gray-50 pt-20 pb-8">
        ...
        <h1 className="text-center text-lg pt-10">
          Copyright &copy; Chirag Suthar | All Rights Reserved
        </h1>
      </div>
    </>
  );
