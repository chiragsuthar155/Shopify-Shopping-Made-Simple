...
export default function Navbar() {
  ...
  return (
    <>
      <div className="flex flex-row items-center justify-around md:justify-between px-2 py-8 md:p-6 gap-10 ml-0 lg:ml-72  ">
        ...
        <div className="cart flex flex-row cursor-pointer items-center relative gap-1">
          <Link to="/cart">
            <img
              ...
              alt="Cart"
            />
            <p className="font-black text-lg bg-emerald-500 absolute md:bottom-6 md:left-5 h-4 w-4 flex flex-row justify-center items-center p-3 bottom-4 left-4 rounded-full">
              {cartItems}
            </p>
          </Link>
        </div>
